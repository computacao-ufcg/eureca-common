...
public class HttpRequestClientTest {
    ...
    public void testDoGenericRequestWithInvalidURL() throws EurecaException {
        // set up
    ...
    public void testDoGenericRequestWithoutAValidConnection() throws EurecaException {
        // set up
        HttpMethod httpMethod = HttpMethod.GET;
    ...
    public void testSetMethodIntoConnectionSuccessfully() throws Exception {
        ...
        // verify
        Mockito.verify(connection, Mockito.times(RUN_ONCE)).setRequestMethod(Mockito.eq(methodName));
    }
    ...
    @Test
    public void testCreateConnectionUrlFail() throws EurecaException {
        // set up
